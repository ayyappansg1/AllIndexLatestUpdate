...
protected static final Logger logger = LoggerFactory.getLogger(ManualSearchpage.class);
    ...
    public void deselectOneSelectStocks() throws InterruptedException {
    	localHelper.clickOneElement(cancelSelectedStocksfromSelectedStocks, driver);
    	logger.info("Deselecting all selected stocks");
    ...
    public void clickResetToMarketCap() {
    	localHelper.clickElement(resetToEqualWeightLabel, driver);
    	logger.info("Reset to Market Cap is Clicked");
    }
    ...
    public List<String> getEquallyDividedWeightLabels() throws AWTException {
    	logger.info("List of Equally divided weights Returned as a List of String");
    	localHelper.robotZoomout(driver);
    	logger.info("Zoom out page");
    	List<String> allText = localHelper.getAllAttributeValue(driver.findElements(equallyDividedWeightLabel), driver,"value");
    	return allText;
    }
...
//    	localHelper.clearElement(nameTextBox, driver);
    ...
    public void uploadExcelFileWithAllField(WebDriver driver) throws AWTException, InterruptedException {
    	//localHelper.sendKeys(uploadButton,"C:\\Users\\ayyappan.g\\git\\AllIndex\\AllIndex\\portfolio_format.xlsx", driver);
		String location=System.getProperty("user.dir")+"\\portfolio_format AllFields.xlsx";
    	localHelper.clickElement(uploadButton, driver);
    	Thread.sleep(2000);
    	localHelper.uploadUsingRobot(location,driver,afterUpload);
    	//Thread.sleep(30000);
    ...
    public void uploadExcelFileWithTwoFieldsOnly(WebDriver driver) throws AWTException, InterruptedException {
    	//localHelper.sendKeys(uploadButton,"C:\\Users\\ayyappan.g\\git\\AllIndex\\AllIndex\\portfolio_format.xlsx", driver);
		String location=System.getProperty("user.dir")+"\\portfolio_format AllFieldsWithoutNetFlix.xlsx";
    	localHelper.clickElement(uploadButton, driver);
    	Thread.sleep(2000);
    	localHelper.uploadUsingRobot(location,driver,afterUpload);
    	//Thread.sleep(30000);
    ...
    public List<String> getAllText() {
    	...
    	return localHelper.getAllText(labelOfSelectedStocks, driver);
    }
