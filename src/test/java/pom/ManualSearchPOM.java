...
public class ManualSearchPOM  extends BaseClass{
	...
	public By resetToEqualWeightLabel=By.xpath("//button[text()='Reset to Market Cap Weight']");
	...
	public By equallyDividedWeightLabel=By.xpath("//div[contains(@class,'wizard-weighting-stock')]//label");
	...
	public By labelOfSelectedStocks=By.xpath("//div[@class='css-tbjym7']//h6");
	public By backButton=By.xpath("(//button[text()='Back'])[2]");
